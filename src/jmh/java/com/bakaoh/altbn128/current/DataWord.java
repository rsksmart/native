...
public final class DataWord implements Comparable<DataWord> {
    ...
    public String toString() {
        return BenchMarkData.bytesToHex(data);
    }
    ...
    public String toPrefixString() {
        ...
        if (pref.length < 7) {
            return BenchMarkData.bytesToHex(pref);
        }

        return BenchMarkData.bytesToHex(pref).substring(0, 6);
    }

    public String shortHex() {
        String hexValue = BenchMarkData.bytesToHex(getNoLeadZeroesData()).toUpperCase();
...
//        }
    ...
    public boolean isHex(String hex) {
        return BenchMarkData.bytesToHex(data).equals(hex);
    }
    ...
    public static DataWord valueFromHex(String data) {
        return valueOf(BenchMarkData.hexStringToByteArray(data));
    }
