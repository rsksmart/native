...
//export Java_com_bakaoh_altbn128_cloudflare_JniBn128_add
func Java_com_bakaoh_altbn128_cloudflare_JniBn128_add(env *C.JNIEnv, clazz C.jclass, x C.jbyteArray, len C.jint, y C.jbyteArray) C.jint {
...
//export Java_com_bakaoh_altbn128_cloudflare_JniBn128_mul
func Java_com_bakaoh_altbn128_cloudflare_JniBn128_mul(env *C.JNIEnv, clazz C.jclass, x C.jbyteArray, len C.jint, y C.jbyteArray) C.jint {
	cData := C.getCByteArray(env, x)
	slice := C.GoBytes(unsafe.Pointer(cData), len)
	defer C.releaseCByteArray(env, x, cData)
...
//export Java_com_bakaoh_altbn128_cloudflare_JniBn128_pairing
func Java_com_bakaoh_altbn128_cloudflare_JniBn128_pairing(env *C.JNIEnv, clazz C.jclass, x C.jbyteArray, len C.jint, y C.jbyteArray) C.jint {
	cData := C.getCByteArray(env, x)
	slice := C.GoBytes(unsafe.Pointer(cData), len)
	defer C.releaseCByteArray(env, x, cData)
