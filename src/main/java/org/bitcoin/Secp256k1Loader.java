...
//        String secp256k1NativeLibraryPath = System.getProperty("fr.acinq.secp256k1.lib.path");
        String secp256k1NativeLibraryPath = System.getProperty("co.rsk.secp256k1.lib.path");
        String secp256k1NativeLibraryName = System.getProperty("co.rsk.secp256k1.lib.name");
        ...
        String resourcePath = secp256k1NativeLibraryPath + "/" + secp256k1NativeLibraryName;
        boolean hasNativeLib = hasResource(resourcePath);
